...
// type_def THugeCP= {  CGTY_HUGE_CODE_PTR,6,      TYPE_POINTER + TYPE_CODE };
type_def TLongCP= {  CGTY_LONG_CODE_PTR,6,      TYPE_POINTER + TYPE_CODE };
type_def TNearCP= {  CGTY_NEAR_CODE_PTR,4,      TYPE_POINTER + TYPE_CODE };
type_def THugeP = {  CGTY_HUGE_POINTER, 6,      TYPE_POINTER };
type_def TLongP = {  CGTY_LONG_POINTER, 6,      TYPE_POINTER };
