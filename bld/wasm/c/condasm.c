...
/*****************************************/
{
   ...
   switch( direct )
   {
      ...
      case T_IFE:
         ...
         break;
      case T_IFDEF:
         CurState = check_defd( AsmBuffer[i+1]->string_ptr )
                    ? ACTIVE : LOOKING_FOR_TRUE_COND;
         break;
      case T_IFNDEF:
         CurState = !check_defd( AsmBuffer[i+1]->string_ptr )
         ...
         break;
      case T_IFB:
         CurState = check_blank( AsmBuffer[i+1]->string_ptr )
                    ? ACTIVE : LOOKING_FOR_TRUE_COND;
         break;
      case T_IFNB:
         CurState = !check_blank( AsmBuffer[i+1]->string_ptr )
         ...
         break;
      case T_IFDIF:
         CurState = check_dif( TRUE, AsmBuffer[i+1]->string_ptr,
                               AsmBuffer[i+3]->string_ptr )
                    ? ACTIVE : LOOKING_FOR_TRUE_COND;
         break;
      case T_IFDIFI:
         CurState = check_dif( FALSE, AsmBuffer[i+1]->string_ptr,
                               AsmBuffer[i+3]->string_ptr )
                    ? ACTIVE : LOOKING_FOR_TRUE_COND;
         break;
      case T_IFIDN:
