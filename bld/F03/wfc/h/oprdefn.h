...
pick( OPR_PHI,  OPRI_PHI,      OPTR_NONE    ) //  null operator
pick( OPR_TRM,  OPRI_TRM,      OPTR_NONE    ) //  start/terminate symbol
pick( OPR_FBR,  OPRI_FBR,      OPTR_NONE    ) //  function/array bracket
pick( OPR_LBR,  OPRI_LBR,      OPTR_NONE    ) //  (
pick( OPR_COM,  OPRI_COM,      OPTR_NONE    ) //  ,
pick( OPR_COL,  OPRI_COL,      OPTR_NONE    ) //  :
