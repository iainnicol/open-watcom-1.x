...
//===============================================
bool    ReqOperator( OPR operatort, int error )
{
    if( operatort == CITNode->opr )
    {
        return true;
    }
    Error( error );
...
//===================================
bool    RecNextOpr( OPR operatort )
{
    return( operatort == CITNode->link->opr );
}


//==============================================
bool    ReqNextOpr( OPR operatort, int error )
{
    if( RecNextOpr( operatort ) )
    {
        return true ;
    }
    AdvError( error );
