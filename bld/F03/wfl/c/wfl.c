...
#if _CPU == 386
    #define     _NAME_  "Fortran 2003/32 Experimental "
#elif _CPU == 8086
    #define     _NAME_  "Fortran 2003/16 Experimental "
#elif _CPU == _AXP
    #define     _NAME_  "Fortran 2003 Alpha AXP Experimental "
#elif _CPU == _PPC
    #define     _NAME_  "Fortran 2003 PowerPC Experimental "
#else
