...
pick( PT_CPLX_8,      TY_COMPLEX,   DBG_NIL_TYPE, T_COMPLEX       ) // COMPLEX*8
pick( PT_CPLX_16,     TY_DCOMPLEX,  DBG_NIL_TYPE, T_DCOMPLEX      ) // COMPLEX*16
pick( PT_CPLX_32,     TY_XCOMPLEX,  DBG_NIL_TYPE, T_XCOMPLEX      ) // COMPLEX*32
pick( PT_CHAR,        TY_CHAR,      DBG_NIL_TYPE, T_LOCAL_POINTER ) // CHARACTER
pick( PT_STRUCT,      TY_STRUCTURE, DBG_NIL_TYPE, T_USER_DEFINED  ) // STRUCTURE
pick( PT_ARRAY,       TY_NO_TYPE,   DBG_NIL_TYPE, T_USER_DEFINED  ) // ARRAY
