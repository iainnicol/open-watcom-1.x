...
[ IFDEF (os_zdos) <2*> ]
    <CPCMD> <PROJDIR>/zdos386/wl.exe                    <RELROOT>/rel2/binz/wlink.exe
    <CPCMD> <PROJDIR>/zdos386/wl.sym                    <RELROOT>/rel2/binz/sym/wlink.sym
    <CPCMD> <PROJDIR>/wlbinz.lnk                        <RELROOT>/rel2/binz/wlink.lnk
