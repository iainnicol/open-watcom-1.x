...
.code
    ...
    clflush     x
    cmpeqpd     xmm1,cs:[bx+di+10]
    cmpeqpd     xmm1,cs:[ebx+2*eax+10]
    cmpeqpd     xmm1,x
    cmpeqpd     xmm1,xmm6
    cmpeqsd     xmm1,cs:[bx+di+10]
    cmpeqsd     xmm1,cs:[ebx+2*eax+10]
    cmpeqsd     xmm1,x
    cmpeqsd     xmm1,xmm6
    cmplepd     xmm1,cs:[bx+di+10]
    cmplepd     xmm1,cs:[ebx+2*eax+10]
    cmplepd     xmm1,x
    cmplepd     xmm1,xmm6
    cmplesd     xmm1,cs:[bx+di+10]
    cmplesd     xmm1,cs:[ebx+2*eax+10]
    cmplesd     xmm1,x
    cmplesd     xmm1,xmm6
    cmpltpd     xmm1,cs:[bx+di+10]
    cmpltpd     xmm1,cs:[ebx+2*eax+10]
    cmpltpd     xmm1,x
    cmpltpd     xmm1,xmm6
    cmpltsd     xmm1,cs:[bx+di+10]
    cmpltsd     xmm1,cs:[ebx+2*eax+10]
    cmpltsd     xmm1,x
    cmpltsd     xmm1,xmm6
    cmpneqpd    xmm1,cs:[bx+di+10]
    cmpneqpd    xmm1,cs:[ebx+2*eax+10]
    cmpneqpd    xmm1,x
    cmpneqpd    xmm1,xmm6
    cmpneqsd    xmm1,cs:[bx+di+10]
    cmpneqsd    xmm1,cs:[ebx+2*eax+10]
    cmpneqsd    xmm1,x
    cmpneqsd    xmm1,xmm6
    cmpnlepd    xmm1,cs:[bx+di+10]
    cmpnlepd    xmm1,cs:[ebx+2*eax+10]
    cmpnlepd    xmm1,x
    cmpnlepd    xmm1,xmm6
    cmpnlesd    xmm1,cs:[bx+di+10]
    cmpnlesd    xmm1,cs:[ebx+2*eax+10]
    cmpnlesd    xmm1,x
    cmpnlesd    xmm1,xmm6
    cmpnltpd    xmm1,cs:[bx+di+10]
    cmpnltpd    xmm1,cs:[ebx+2*eax+10]
    cmpnltpd    xmm1,x
    cmpnltpd    xmm1,xmm6
    cmpnltsd    xmm1,cs:[bx+di+10]
    cmpnltsd    xmm1,cs:[ebx+2*eax+10]
    cmpnltsd    xmm1,x
    cmpnltsd    xmm1,xmm6
    cmpordpd    xmm1,cs:[bx+di+10]
    cmpordpd    xmm1,cs:[ebx+2*eax+10]
    cmpordpd    xmm1,x
    cmpordpd    xmm1,xmm6
    cmpordsd    xmm1,cs:[bx+di+10]
    cmpordsd    xmm1,cs:[ebx+2*eax+10]
    cmpordsd    xmm1,x
    cmpordsd    xmm1,xmm6
    ...
    cmpunordpd  xmm1,cs:[bx+di+10]
    cmpunordpd  xmm1,cs:[ebx+2*eax+10]
    cmpunordpd  xmm1,x
    cmpunordpd  xmm1,xmm6
    cmpunordsd  xmm1,cs:[bx+di+10]
    cmpunordsd  xmm1,cs:[ebx+2*eax+10]
    cmpunordsd  xmm1,x
    cmpunordsd  xmm1,xmm6
