...
{
    return CGLVAssign( objInitField( fctl, init, 0 ), expr, CGTY_POINTER );
}
    ...
    ( SE* se )                  // - component for actual base
{
    ...
    expr1 = CGLVAssign( CgSymbolPlusOffset( se->component.obj->sym
                      ...
                      , CGInteger( DTOR_COMPONENT, CGTY_UINT_1 )
                      , CGTY_UINT_1 );
#if 0
    ...
    expr2 = CGLVAssign( CgSymbolPlusOffset( se->component.obj->sym, 0 )
                      ...
                      , CGTY_POINTER );
#endif
    expr2 =  CgComma( expr1, expr2, CGTY_POINTER );
    return expr2;
}
