...
;
		...
		PUBLIC	BiosScrollWindowUp_
;
; DECLARATION	int BiosScrollWindowUp( int lowerY, int lowerX,
;                                       int upperY, int upperX,
;                                       int rows, int blankingattr );
;
PROC		BiosScrollWindowUp_	STDCALL
		...
		mov	ah,VIDEO_SCROLL_UP		; AH = video function
		;
		; Call BIOS
		;
IFDEF __ZDOSDRV__
